  ...
  return (
    <div className="notes-content">
      ...
      <h4>Project Ideas!</h4>
          ...
          <img src="https://cdn.mos.cms.futurecdn.net/v2/t:0,l:761,cw:2507,ch:2507,q:80,w:2507/ycUVcqfyCDs44UkYCwTzMA.jpg" width={200}></img>
          <img src="https://hackster.imgix.net/uploads/attachments/970091/1__17qQs2JPE9BjT_xMFaw1Q.jpeg?auto=&format=jpg" width={200}></img>
          <img src="https://miro.medium.com/v2/resize:fit:1400/1*k_-V1FZUhA5AEBXmwUiS7A.jpeg" width={200}></img>
          ...
          <img src='https://botland.store/img/art/inne/24057_8.jpg' width={300}></img>
          <img src='https://lilygo.cc/cdn/shop/files/LILYGO-T-DECK-PRO_9.jpg?v=1742883880' width={300}></img>
          <img src="https://images.musicstore.de/images/0960/teenage-engineering-ep-133-k-o-ii_1_SYN0008856-000.jpg" width={300}></img>
          <img src='https://teenage.engineering/_img/store/c91abe82329a4d40168256414da501fd9a456e5b8a5c7d2a2702c54cd704fa1e.webp' width={300}></img>
    </div>
  );
};
